...
export default {
  ...
  render(h) {
    ...
    if (this.collapseTransition) {
      return h("ml-menu-collapse-transition", [component]);
    } else {
      return component;
    }
  },

  componentName: "MlMenu",
      ...
      render(createElement, context) {
        const data = {
          ...
          on: {
            ...
            enter(el) {
              addClass(el, "ml-opacity-transition");
              el.style.opacity = 1;
            },

            afterEnter(el) {
              removeClass(el, "ml-opacity-transition");
              el.style.opacity = "";
            },
            ...
            beforeLeave(el) {
              ...
              if (hasClass(el, "ml-menu--collapse")) {
                removeClass(el, "ml-menu--collapse");
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                addClass(el, "ml-menu--collapse");
              } else {
                addClass(el, "ml-menu--collapse");
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
  ...
  watch: {
    ...
    collapse(value) {
      ...
      this.broadcast("MlSubmenu", "toggle-collapse", value);
    }
  },
  methods: {
