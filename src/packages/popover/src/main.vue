<template>
  <span>
    ...
    >
      <div
        class="ml-popover ml-popper"
        :class="[popperClass, content && 'ml-popover--plain']"
        ref="popper"
...
export default {
  ...
  mounted() {
    ...
    // 可访问性
    if (reference) {
      addClass(reference, "ml-popover__reference");
