...
export default {
  ...
  props: {
    ...
    iconClasses: {
      type: [Array, Object],
      default() {
        return ["ml-icon-star-on", "ml-icon-star-on", "ml-icon-star-on"];
      }
    },
    voidIconClass: {
      type: String,
      default: "ml-icon-star-off"
    },
    disabledVoidIconClass: {
      type: String,
      default: "ml-icon-star-on"
    },
    disabled: {
      type: Boolean,
      default: false
  ...
  methods: {
    ...
    setCurrentValue(value, event) {
      ...
      if (this.allowHalf) {
        ...
        if (hasClass(target, "ml-rate__item")) {
          target = target.querySelector(".ml-rate__icon");
        }
        if (hasClass(target, "ml-rate__decimal")) {
