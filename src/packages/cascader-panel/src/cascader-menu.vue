...
export default {
  ...
  methods: {
    ...
    renderEmptyText(h) {
      return h(
        "div",
        { class: "ml-cascader-menu__empty-text" },
        this.t("moli.cascader.noData")
      );
    },
    renderNodeList(h) {
      const { menuId } = this;
      ...
      return [
        ...
        isHoverMenu
          ? h("svg", {
              ref: "hoverZone",
              class: "ml-cascader-menu__hover-zone"
            })
          : null
      ];
    }
  ...
  render(h) {
    ...
    return h(
      "ml-scrollbar",
      {
        class: "ml-cascader-menu",
        attrs: {
          tag: "ul",
          role: "menu",
          id: menuId,
          "wrap-class": "ml-cascader-menu__wrap",
          "view-class": {
            "ml-cascader-menu__list": true,
            "is-empty": isEmpty
          }
        },
        ...events
