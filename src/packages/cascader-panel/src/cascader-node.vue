...
export default {
  ...
  methods: {
    ...
    renderCheckIcon(h) {
      return h("i", { class: "ml-icon-right ml-cascader-node__prefix" });
    },
    renderLoadingIcon(h) {
      return h("i", { class: "ml-icon-loading ml-cascader-node__postfix" });
    },
    renderExpandIcon(h) {
      return h("i", { class: "ml-icon-arrow-right ml-cascader-node__postfix" });
    },
    renderContent(h) {
