        ...
        _ => {
          ...
          const target =
            binding.modifiers.fullscreen || binding.modifiers.body
              ? document.body
              : el;
          removeClass(target, "ml-loading-parent--relative");
          removeClass(target, "ml-loading-parent--hidden");
  ...
  const insertDom = (parent, el, binding) => {
    if (
      ...
      if (
        ...
        addClass(parent, "ml-loading-parent--relative");
      }
      if (binding.modifiers.fullscreen && binding.modifiers.lock) {
        addClass(parent, "ml-loading-parent--hidden");
      }
      el.domVisible = true;
