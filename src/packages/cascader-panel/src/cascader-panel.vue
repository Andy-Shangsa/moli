  ...
  methods: {
        ...
        case KeyCode.left:
          ...
          if (preMenu) {
            const expandedNode = preMenu.$el.querySelector(
              '.ml-cascader-node[aria-expanded="true"]'
            );
    ...
    scrollIntoView() {
      ...
      menus.forEach(menu => {
        ...
        if (menuElement) {
          const container = menuElement.querySelector(".ml-scrollbar__wrap");
          const activeNode =
            menuElement.querySelector(".ml-cascader-node.is-active") ||
            menuElement.querySelector(".ml-cascader-node.in-active-path");
