<template>
  ...
  >
    <div
      v-show="visible"
      class="ml-picker-panel ml-date-range-picker ml-popper"
      :class="[{
        'has-sidebar': $slots.sidebar || shortcuts,
        'has-time': showTime
      }, popperClass]"
    >
      <div class="ml-picker-panel__body-wrapper">
        <slot
          name="sidebar"
          class="ml-picker-panel__sidebar"
        ></slot>
        <div
          class="ml-picker-panel__sidebar"
          v-if="shortcuts"
        >
          <button
            type="button"
            class="ml-picker-panel__shortcut"
            v-for="(shortcut, key) in shortcuts"
            :key="key"
            @click="handleShortcutClick(shortcut)"
          >{{shortcut.text}}</button>
        </div>
        <div class="ml-picker-panel__body">
          <div
            class="ml-date-range-picker__time-header"
            v-if="showTime"
          >
            <span class="ml-date-range-picker__editors-wrap">
              <span class="ml-date-range-picker__time-picker-wrap">
                <ml-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('moli.datepicker.startDate')"
                  class="ml-date-range-picker__editor"
              ...
              <span
                class="ml-date-range-picker__time-picker-wrap"
              ...
              >
                <ml-input
                  ...
                  class="ml-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('moli.datepicker.startTime')"
            ...
            <span class="ml-date-range-picker__editors-wrap is-right">
              <span class="ml-date-range-picker__time-picker-wrap">
                <ml-input
                  size="small"
                  class="ml-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('moli.datepicker.endDate')"
              ...
              >
                <ml-input
                  ...
                  class="ml-date-range-picker__editor"
                  :disabled="rangeState.selecting"
                  :placeholder="t('moli.datepicker.endTime')"
          ...
          <div class="ml-picker-panel__content ml-date-range-picker__content is-left">
            <div class="ml-date-range-picker__header">
              <button
                type="button"
                @click="leftPrevYear"
                class="ml-picker-panel__icon-btn ml-icon-d-arrow-left"
              ></button>
              <button
                type="button"
                @click="leftPrevMonth"
                class="ml-picker-panel__icon-btn ml-icon-arrow-left"
              ></button>
              <button
                type="button"
                @click="leftNextYear"
                ...
                class="ml-picker-panel__icon-btn ml-icon-d-arrow-right"
              ></button>
              <button
                type="button"
                @click="leftNextMonth"
                ...
                class="ml-picker-panel__icon-btn ml-icon-arrow-right"
              ></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
          ...
          <div class="ml-picker-panel__content ml-date-range-picker__content is-right">
            <div class="ml-date-range-picker__header">
              <button
                type="button"
                @click="rightPrevYear"
      ...
      <div
        class="ml-picker-panel__footer"
        v-if="showTime"
      >
        <ml-button
          size="mini"
          type="text"
          class="ml-picker-panel__link-btn"
          @click="handleClear"
        >
          {{ t('moli.datepicker.clear') }}
        </ml-button>
        <ml-button
          plain
          size="mini"
...
export default {
  ...
  computed: {
    ...
    leftLabel() {
      return (
        ...
        " " +
        this.t("moli.datepicker.year") +
        " " +
        this.t(`moli.datepicker.month${this.leftDate.getMonth() + 1}`)
      );
    },
    rightLabel() {
      return (
        ...
        this.t("moli.datepicker.year") +
        " " +
        this.t(`moli.datepicker.month${this.rightDate.getMonth() + 1}`)
      );
    },
    leftYear() {
  ...
  components: { TimePicker, DateTable, MlInput, MlButton }
};
</script>
