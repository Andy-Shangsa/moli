  ...
  >
    <template v-if="!arrowControl">
      <ml-scrollbar
        ...
        class="ml-time-spinner__wrapper"
        wrap-style="max-height: inherit;"
        view-class="ml-time-spinner__list"
        noresize
        tag="ul"
        ref="hours"
      >
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="ml-time-spinner__wrapper is-arrow"
      >
        <i
          v-repeat-click="decrease"
          class="ml-time-spinner__arrow ml-icon-arrow-top"
        ></i>
        <i
          v-repeat-click="increase"
          class="ml-time-spinner__arrow ml-icon-arrow-down"
        ></i>
        <ul
          class="ml-time-spinner__list"
          ref="hours"
        >
          <li
            class="ml-time-spinner__item"
