...
export default {
  ...
  methods: {
    ...
    setPosition(newPosition) {
      ...
      this.$nextTick(() => {
        this.displayTooltip();
        console.log(this.$refs.tooltip && this.$refs.tooltip.updatePopper);
    ...
    return h(
      "div",
      {
        class: [
          ...
          { hover: this.hovering, dragging: this.dragging }
        ],
      ...
      [
        h(
          "ml-tooltip",
          {
            ref: "tooltip",
            attrs: {
              "popper-class": this.tooltipClass,
              placement: "top",
              disabled: !this.showTooltip
            }
          },
          [
            h("span", { slot: "content" }, this.formatValue),
            h("div", {
              class: [
                "ml-slider__button",
                { hover: this.hovering, dragging: this.dragging }
