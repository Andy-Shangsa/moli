<template>
  ...
  >
    <div
      v-show="visible"
      class="ml-time-range-picker ml-picker-panel ml-popper"
      :class="popperClass"
    >
      <div class="ml-time-range-picker__content">
        <div class="ml-time-range-picker__cell">
          <div class="ml-time-range-picker__header">{{ t('moli.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="ml-time-range-picker__body ml-time-panel__content"
          >
            <time-spinner
              ref="minSpinner"
        ...
        <div class="ml-time-range-picker__cell">
          <div class="ml-time-range-picker__header">{{ t('moli.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="ml-time-range-picker__body ml-time-panel__content"
          >
      ...
      <div class="ml-time-panel__footer">
        <button
          type="button"
          class="ml-time-panel__btn cancel"
          @click="handleCancel()"
        >{{ t('moli.datepicker.cancel') }}</button>
        <button
          type="button"
          class="ml-time-panel__btn confirm"
          @click="handleConfirm()"
          :disabled="btnDisabled"
        >{{ t('moli.datepicker.confirm') }}</button>
      </div>
    </div>
  </transition>
</template>
