<template>
  <ml-input
    class="ml-date-editor"
    :class="'ml-date-editor--' + type"
  ...
  <div
    class="ml-date-editor ml-range-editor ml-input__inner"
    :class="[
      'ml-date-editor--' + type,
      pickerSize ? `ml-range-editor--${ pickerSize }` : '',
    ...
    v-else
  >
    <i :class="['ml-input__icon', 'ml-range__icon', triggerClass]"></i>
    <input
      autocomplete="off"
      ...
      @focus="handleFocus"
      class="ml-range-input"
    >
    <slot name="range-separator">
      <span class="ml-range-separator">{{ rangeSeparator }}</span>
    </slot>
    <input
      autocomplete="off"
    ...
    <i
      ...
      v-if="haveTrigger"
      :class="[showClose ? '' + clearIcon : '']"
      class="ml-input__icon ml-range__close-icon"
    >
    </i>
  </div>
</template>
...
export default {
    ...
    pickerVisible(val) {
      ...
      if (val) {
        ...
        if (this.validateEvent) {
          this.dispatch("MlFormItem", "moli.form.blur");
        }
        this.$emit("blur", this);
        this.blur();
      }
  ...
  computed: {
    ...
    triggerClass() {
      return (
        this.prefixIcon ||
        (this.type.indexOf("time") !== -1 ? "ml-icon-time" : "ml-icon-date")
      );
    },
    selectionMode() {
      if (this.type === "week") {
